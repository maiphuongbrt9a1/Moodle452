 ...
 * @since      Moodle 3.2
 */
class auth_twiliootp_external extends external_api {
    ...
    protected static function check_signup_enabled() {
        ...
        if (empty($CFG->registerauth) or $CFG->registerauth != 'twiliootp') {
    ...
    public static function signup_user_parameters() {
        return new external_function_parameters(
            array(
                ...
                'twiliootp' => new external_value(core_user::get_property_type('twiliootp'), 'A valid and unique twiliootp address'),
     ...
     * @param  string $twiliootp                  a valid and unique twiliootp address
     ...
     */
    public static function signup_user($username, $password, $firstname, $lastname, $twiliootp, $city = '', $country = '',
        ...
        $data = $params;
        $data['twiliootp2'] = $data['twiliootp'];
        ...
        if (!empty($errors)) {
            ...
            $authplugin = get_auth_plugin('twiliootp');
